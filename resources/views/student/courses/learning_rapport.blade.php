                ...
                <div
                    ...
                    @if($answer->answer == 'correct')
                        <div class="flex items-center gap-[14px]">
                            <p class="bg-[#06BC65] rounded-full p-[8px_20px] text-white font-semibold text-sm">{{$answe->answer}}</p>
                        </div>
                    @else
                        <div class="flex items-center gap-[14px]">
                            <p class="bg-[#FD445E] rounded-full p-[8px_20px] text-white font-semibold text-sm">{{$answe->answer}}</p>
                        </div>
                    @endif
                </div>
            @empty
