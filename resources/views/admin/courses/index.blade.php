...
<section id="content" class="flex">
            ...
            <ul class="flex flex-col gap-3">
                ...
                <li>
                    <form method="post" action="{{ route('logout') }}">
                        @csrf
                        <button type="submit" href="signin.html"
    ...
    <div id="menu-content" class="flex flex-col w-full pb-[30px]">
        ...
        <div class="course-list-container flex flex-col px-5 mt-[30px] gap-[30px]">
                    ...
                    <div class="flex shrink-0 w-[120px] items-center">
                        <div class="relative h-[41px]">
                            <div
                                ...
                                <a href="{{ route('dashboard.course.show', $course) }}"
                                   class="flex items-center justify-between font-bold text-sm w-full">
                                    Manage
                                </a>
                                ...
                                <a href="{{ route('dashboard.course.edit', $course) }}"
                                   class="flex items-center justify-between font-bold text-sm w-full">
                                    Edit Course
                                </a>
                                <form method="post" action="{{ route('dashboard.course.destroy', $course) }}">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit"
            ...
            @empty
                <div class="flex justify-center items-center w-full h-[200px] border border-[#EEEEEE] rounded-[18px]">
                    <p class="text-[#7F8190]">No course found</p>
                </div>
            @endforelse
        </div>
    </div>
